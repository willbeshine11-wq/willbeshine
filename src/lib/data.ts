...
export const founder = {
  ...
  bio: "우숙현 대표는 13년간 치과위생사 실장으로 근무하며 신환 상담부터 재진 관리, 컴플레인 대응까지 병원 운영의 현장을 직접 경험했습니다. 광고 대행사 출신 마케터가 알기 어려운 '환자가 실제로 망설이는 지점'과 '원장님이 진짜 걱정하는 리스크'를 데이터가 아니라 몸으로 이해하고 있다는 것이 하이스타트만의 차별점입니다.",
};
